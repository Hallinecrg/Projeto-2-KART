programa
{
	...
	funcao real ReceitaSomar( cadeia modelo[], real valor[])
	{
		inteiro i, cadastrar = 0
		real ReceitaD = 0.0

		para(i = 0; i < 15; i++)
		{
			se(modelo[i] == "" e cadastrar ==0)
			{
				se(valor[i] < 0)
				{
					ReceitaD = 0 + ReceitaD
	...
	funcao mostraMenu(){
		...
		escreva("9. Receita e lucro do dia, considerando Karts locados\n\n")u.aguarde(150)
	...
	funcao inicio(){
		...
		real receitaTotal = 0.0, LucroTotal = 0.0, Receita = 0.0
