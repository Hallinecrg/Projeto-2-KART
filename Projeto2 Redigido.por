programa
{
	...
	funcao inicio()
	{
	    ...
	    cadeia Devolver = "Nome", MaiorKart
		 ...
		 escreva("Deseja cadastrar um kart? (Digite sim ou aperte enter para ir na área de locação)\n")
		 leia(opcao)
          ...
          enquanto (Cadastrar>0)
		{
		 ...
		 se(Cadastrar>0)
		 {
           ...
           { 
          	...
          	enquanto(Alugar>0)
          	{
          	escreva("Deseja alugar um kart? (Digite sim ou aperte enter para fechar o programa)\n")
		     ...
		     se(Alugados == 14)
		     {
		     	...
		     	escreva("Deseja alugar um kart? (Digite sim ou aperte enter para não) \n")
		     	leia(opcao)
		      ...
		      para(Inicio=0; Inicio<14; Inicio++)
		      {
		      	...
		      	escreva(":", kart[Inicio],"\n")
                    ...
                    se(livres == 10)
                    {
                       escreva("Gostaria de alugar esse modelo?(Digite sim ou aperte enter para não) \n")
		             leia(modelo)
                    ...
                    se(Tempo > 0)
		          {
		            escreva("Quanto tempo irá ficar alugado?")
		            leia(tempo)
		          }
